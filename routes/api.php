...
use App\Http\Controllers\Api\CateringTestimomnialController;
...
Route::get('filter/catering-packages', [CategoryController::class, 'filterPackages']);
...
Route::apiResource('testimonials', CateringTestimomnialController::class);

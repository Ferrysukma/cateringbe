...
class CateringSubscription extends Model
{
    ...
    protected $fillable = [
        'booking_trx_id', 'name', 'phone', 'email', 'delivery_time', 'proof', 'post_code', 'city', 'notes', 'address', 'total_amount', 'price', 'duration', 'quantity', 'total_tax_amount', 'is_paid', 'started_at', 'ended_at', 'catering_package_id', 'catering_tier_id'
    ];

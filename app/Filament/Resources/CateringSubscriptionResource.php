...
class CateringSubscriptionResource extends Resource
{
    ...
    {
        return (string) CateringSubscription::where('is_paid', 0)->count();
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Wizard::make([
                    ...
                    ->schema([
                        ...
                        ->schema([
                            ...
                            ->label('Catering Tier')
                            // ->options(CateringTier::where('catering_package_id', 1)->pluck('name', 'id'))
                    ...
                    ->completedIcon('heroicon-m-hand-thumb-up')
                    ->description('Fill your identity')
                    ->schema([
                        Grid::make(2)
                        ->schema([
                ...
                ->columnSpan('full') // use for full width
                ->columns(1) // make sure only 1 column
                ->skippable()
            ]);
    }
        ...
        return $table
            ...
            ->actions([
                ...
                ->action(function (CateringSubscription $record) {
                    ...
                    ->success()
                    ->body('The orer has been successfully approved')
                    ->send();
                })
                ->color('success')
